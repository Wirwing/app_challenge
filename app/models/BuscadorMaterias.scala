...
//		Logger.info( failedSubjects.toString )
	...
	def checkSatisfiedDependencies( alumnoId: Int, asignaturaId: Int ) = {
	...
	def getOfferByAproved( studentId: Int ) =  {
	...
	def getOfferByFail( studentId: Int ) =  {
